        ...
        let menuHTML = `
            <div id="menu-content" class="container mx-auto px-4 py-8">
                <div class="text-center mb-8">
                    ...
                    <p class="text-lg text-white">Authentic Brazilian flavors and fresh baked goods at Camilla's Café</p>
                </div>
        ...
        menuSections.forEach(section => {
            ...
            menuHTML += `
                <div id="${sectionId}" class="mb-16 scroll-mt-16 menu-category">
                    <h2 class="text-3xl font-bold text-white mb-8 pb-2 border-b border-gray-600">${section}</h2>
